                                ...
                                @forelse($reports as $report)
                                    <tr class="report_item">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap flex flex-grow text-right space-x-5 text-sm font-medium">
                                            <a href="{{ route('admin.reports.show',['report'=>$report]) }}" class="report-detail" type="button" class="flex space-x-1 text-indigo-600 hover:text-indigo-900">
                                                <span>
