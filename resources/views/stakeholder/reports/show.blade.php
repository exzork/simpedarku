                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                        ...
                        <div class="border-t border-gray-200 px-4 py-5 sm:p-0">
                            ...
                            <div class="px-4 py-5 sm:px-6">
                                <form action="{{ route('stakeholder.reports.update',['report'=>$report]) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="space-y-8 divide-y divide-gray-200">
                                                ...
                                                <div class="mt-6 sm:mt-5 space-y-6 sm:space-y-5">
                                                    <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                                                        ...
                                                        <div class="mt-1 sm:mt-0 sm:col-span-2">
                                                            @if($report->status != 'COMPLETED' && (auth()->user()->stakeholder_id == $report->stakeholder_id || is_null($report->stakeholder_id)) )
                                                    ...
                                                    <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                                                        ...
                                                        <div class="mt-1 sm:mt-0 sm:col-span-2">
                                                            {{ $report->stakeholder->name ?? auth()->user()->stakeholder->name }}
                                                        </div>
                                                    </div>
                                                    <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                                                        <label for="action"
                                        ...
                                        <div class="pt-5">
                                            <div class="flex justify-end">
                                                <a href="{{ route('stakeholder.reports.index') }}"
