                                ...
                                @forelse($reports as $report)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap flex flex-grow text-right space-x-5 text-sm font-medium">
                                            <a href="{{ route('stakeholder.reports.show',['report'=>$report]) }}" type="button" class="flex space-x-1 text-indigo-600 hover:text-indigo-900">
                                                <span>
                                            ...
                                            @if($report->status == "PENDING")
                                                <form method="POST" action="{{ route('stakeholder.reports.update', ['report'=>$report]) }}">
                                                    @csrf
                                                    @method('PUT')
